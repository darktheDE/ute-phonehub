...
- AF1 – Tồn kho không đủ:
	1. Ở bước 5, nếu số lượng tồn kho không đáp ứng yêu cầu, hệ thống trả về lỗi nghiệp.
...
- AF3 – Merge giỏ hàng tạm sau khi đăng nhập:
	1. Nếu Actor vừa đăng nhập và client gửi kèm guest cart (giỏ tạm trong redis), hệ thống nhận danh sách item tạm.
	...
	4. Hệ thống trả về thông điệp "Đã đồng bộ X sản phẩm từ giỏ hàng tạm".
