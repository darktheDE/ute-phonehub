...
public class PromotionController {
    ...
    // ==========================================
    // ACTOR: ADMINISTRATOR (Manage Promotion)
    // ==========================================
    ...
    @GetMapping("/{id}")
    @Operation(summary = "[Admin/User] See Promotion Detail - Xem chi tiết")
    ...
    // ==========================================
    // ACTOR: CUSTOMER (Apply Promotion)
    // ==========================================

    @GetMapping("/available")
    @Operation(summary = "[Customer] Check & Get Available - Lấy DS khuyến mãi hợp lệ cho đơn hàng")
